...
public class AdminProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = findViewById(R.id.usernameAdminEdit);
        email = findViewById(R.id.emailAdminEdit);
        PhoneNumber = findViewById(R.id.phoneNumberAdminEdit);
        Password = findViewById(R.id.passwordAdminEdit);
        updateButton = findViewById(R.id.updateAdmin);
        ...
        profilePic = findViewById(R.id.profileImageAdmin);

...
public class CurrentLocation extends AppCompatActivity {
        ...
        findViewById(R.id.buttonL).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(
                    ...
                    ActivityCompat.requestPermissions(CurrentLocation.this,new String[] {Manifest.permission.ACCESS_FINE_LOCATION},REQUEST_CODE_LOCATION_PERMISSION);
                }
                else
                {
                    getCurrentLocation();
    ...
    private void getCurrentLocation() {
        ...
        LocationServices.getFusedLocationProviderClient(CurrentLocation.this).requestLocationUpdates(locationRequest,new LocationCallback(){
            @Override
            public void onLocationResult(LocationResult locationResult) {
                super.onLocationResult(locationResult);
                LocationServices.getFusedLocationProviderClient(CurrentLocation.this).removeLocationUpdates(this);
